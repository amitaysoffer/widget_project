...
const images = [
  'https://lh3.googleusercontent.com/proxy/ftS-_zO1Pr-v6g2g-oPrCl-pBnByPdYCONg7t2DwlcGyPEsNyiiP4XH8W3EbOpJxkBHHpRIEPEy36qi_ThSdBAAeeHacvYbNXBUZc9_nrCSl-XiK_5bn6Xi3b1ugIL2QrYiR0hUKXnzhGt_qgTSe2bPrnWM-Vm-34Q',
...
function appendContainer() {
  let headerNode = `<h1 id="header">You may be intrested in...<h1>`
  let containerNode =
    `<div class="arrows">
        <i class="left"></i>
        <i class="right"></i>
